const jobs = [
  {
    id: "caltex",
    name: "Caltex D'Aguilar",       // FIX: Was already title case — kept
    status: "red",
  ...
  {
    id: "childers",
    name: "Pearl Energy Childers",   // FIX: Was ALL CAPS
    status: "amber",
    issue: "Thin labour",
    labour: "Insufficient",
  ...
  {
    id: "williamstown",
    name: "Exus Williamstown",       // FIX: Was ALL CAPS
    status: "grey",
  ...
  {
    id: "emerald",
    name: "Pearl Energy Emerald",    // FIX: Was ALL CAPS
    status: "grey",
